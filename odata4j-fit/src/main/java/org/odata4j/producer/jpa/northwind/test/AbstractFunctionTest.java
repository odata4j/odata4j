 ...
 *
 */
public abstract class AbstractFunctionTest extends AbstractJPAProducerTest implements ConsumerSupport {
  ...
  public void functionComplexObjectTest() {
    ...
    ODataConsumer c = this.create(endpointUri, FormatType.JSON, null);
