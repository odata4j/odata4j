...
public abstract class AbstractCreateTest extends AbstractJPAProducerTest implements ConsumerSupport {
  ...
  public void tunneledInsertEntityToExistingEntityRelationAtom() {
    ODataConsumer consumer = this.create(endpointUri, null, "PUT");
    insertEntityToExistingEntityRelationAndTest(consumer);
  }

  @Test
  public void tunneledInsertEntityToExistingEntityRelationJson() {
    ODataConsumer consumer = this.create(endpointUri, FormatType.JSON, "PUT");
    insertEntityToExistingEntityRelationAndTest(consumer);
  }
  ...
  public void insertEntityToExistingEntityRelationJson() {
    ODataConsumer consumer = this.create(endpointUri, FormatType.JSON, null);
    insertEntityToExistingEntityRelationAndTest(consumer);
  }
