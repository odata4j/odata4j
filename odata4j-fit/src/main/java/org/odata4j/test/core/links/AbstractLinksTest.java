 ...
 */
public abstract class AbstractLinksTest extends AbstractJPAProducerTest implements ConsumerSupport, ProducerSupport {
  ...
  protected void testReadDeferred(FormatType formatType) {
    ODataConsumer consumer = this.create(endpointUri, formatType, null);
