...
public abstract class AbstractJsonTest implements ConsumerSupport, ProducerSupport, WebResourceSupport {
  ...
  public void testJson() {
    ...
    ODataServer server = this.startODataServer(uri);

    try {
      ODataConsumer c = this.create(uri, null, null);
      ...
      String output = this.getWebResource(uri + "Pojo?$format=json", String.class);
