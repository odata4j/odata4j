...
public interface IEdmDecorator {
   ...
   */
  Object resolveStructuralTypeProperty(EdmStructuralType st, Path path) throws Exception;
   ...
   * @throws - Exception if the property does not exist.
   */
  Object resolvePropertyProperty(EdmProperty st, Path path) throws Exception;
   ...
   */
  Object getAnnotationValueOverride(EdmItem item, IAnnotation annot, boolean flatten, Locale locale, Map<String, String> options);
