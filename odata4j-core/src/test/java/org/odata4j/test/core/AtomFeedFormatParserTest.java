...
public class AtomFeedFormatParserTest {
	...
	public void parseEntitySetNameTests(){
		...
		Assert.assertEquals("Alphabetical_list_of_products",AtomFeedFormatParser.parseEntitySetName("http://services.odata.org/northwind/Northwind.svc/Alphabetical_list_of_products(CategoryName='Grains/Cereals',Discontinued=false,ProductID=22,ProductName='Gustaf''s%20Kn%C3%A4ckebr%C3%B6d')"));
